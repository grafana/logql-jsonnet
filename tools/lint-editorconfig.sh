...
# output the heading
heading "LogQL Jsonnet" "Performing Editorconfig Linting using editorconfig-checker"
...
statusCode=0
./node_modules/.bin/editorconfig-checker -config="$(pwd)/.editorconfig" -exclude ".*LICENSE.*"
currentCode="$?"
